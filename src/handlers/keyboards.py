...
def get_settings_markup():
    markup = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text=_("⚙️ Tilni o'zgartirish"),
                                  callback_data="settings_lang"), InlineKeyboardButton(text=_("⚙️ Telefon raqamni o'zgartirish"), callback_data="settings_phone"),],
            [
                InlineKeyboardButton(text=_("🏠 Bosh menyu"), callback_data="settings_home")]
        ], resize_keyboard=True
    )
    return markup
...
def create_inline_buttons(prefix: str, data: List, return_prefix=""):
    ...
    buttons.append([InlineKeyboardButton(text=_("🔙 Orqaga"), callback_data=return_prefix),
                    ])
